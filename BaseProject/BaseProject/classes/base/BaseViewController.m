...
- (void)setLeftItemWithIcon:(UIImage *)icon title:(NSString *)title selector:(SEL)selector {
    self.navigationItem.leftBarButtonItem = [self itemLeftItemWithIcon:icon title:title selector:selector];
}

- (UIBarButtonItem *)itemLeftItemWithIcon:(UIImage *)icon title:(NSString *)title selector:(SEL)selector {
